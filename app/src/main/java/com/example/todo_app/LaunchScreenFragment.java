...
public class LaunchScreenFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @NonNull Bundle savedInstanceState) {
        ...
        //Animation of the components for launch screen
        ...
        launch_background.animate().translationY(-2000).setDuration(2000).setStartDelay(3000);
        lottieAnimationView.animate().translationY(1600).setDuration(2000).setStartDelay(3000);
        TextView textView_title = getView().findViewById(R.id.text_title);
        textView_title.animate().translationY(-1900).setDuration(2000).setStartDelay(3000);
        TextView textView_content = getView().findViewById(R.id.content_id);
        textView_content.animate().translationY(1900).setDuration(2000).setStartDelay(3000);
    }
}